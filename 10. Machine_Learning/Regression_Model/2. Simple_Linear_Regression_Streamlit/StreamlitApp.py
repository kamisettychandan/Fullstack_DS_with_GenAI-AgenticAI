...
model = pickle.load(open(r'C:\Users\Windows10 Pro\Downloads\DataScience_AI\Assignments_JupyterFile\10. Machine_Learning\2. Simple_Linear_Regression_Streamlit\linear_regression_model.pkl', 'rb'))

# Set the title of the Streamlit app
st.title("Salary Prediction App developed by Chandan")
