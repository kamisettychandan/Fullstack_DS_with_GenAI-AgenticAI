...
# Load the dataset
dataset = pd.read_csv(r'C:\Users\Windows10 Pro\Downloads\DataScience_AI\Assignments_JupyterFile\10. Machine_Learning\2. Simple_Linear_Regression_Streamlit\Salary_Data.csv')
